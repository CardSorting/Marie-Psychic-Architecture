...
_Joyful code is where humans think. Guard it fiercely._
...
_Infrastructure exists so joyful code doesn’t have to care._
...
_Plumbing is respected, but never romanticized._
...
_Movement is maturity, not failure._
...
_Pressure valves prevent premature abstraction and false cleanliness._
...
_Agents assist judgment. They do not replace it._
...
_There are no “zoning sprints.” Tidying is part of normal work._
...
_If the answer feels fuzzy, pause. Do not invent abstractions to escape discomfort._
...
_When this happens, simplify the protocol, not the people._
