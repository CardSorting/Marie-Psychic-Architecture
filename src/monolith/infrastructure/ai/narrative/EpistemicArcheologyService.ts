        ...
        try {
            ...
            for (const file of files) {
                ...
                try {
                    ...
                    // Legacy Ruins check
                    if (now - stats.mtimeMs > EpistemicArcheologyService.RUIN_THRESHOLD_MS) {
                        artifacts.push({
                    ...
                    // Sprout check
                    if (now - stats.birthtimeMs < EpistemicArcheologyService.SPROUT_THRESHOLD_MS) {
                        artifacts.push({
                            objectPath: relativePath,
            ...
            subdirs.map(async (subdir) => {
                ...
                try {
                    ...
                    if (stat.isDirectory()) {
                        ...
                        if (subdir === "node_modules" || subdir === ".git" || subdir === "dist") return;
